...
const instructor2 = courseManager.addInstructor("Jane Smith", [courseApp_1.CourseCategory.MARKETING, courseApp_1.CourseCategory.BUSINESS]);
const instructor3 = courseManager.addInstructor("Mike Johnson", [courseApp_1.CourseCategory.DESIGN]);
// Add students
console.log("\n--- Adding Students ---");
...
const course2 = courseManager.createCourse("Advanced JavaScript", courseApp_1.CourseCategory.DEVELOPMENT, instructor1.id);
const course3 = courseManager.createCourse("Digital Marketing Strategy", courseApp_1.CourseCategory.MARKETING, instructor2.id);
const course4 = courseManager.createCourse("UI/UX Design Fundamentals", courseApp_1.CourseCategory.DESIGN, instructor3.id);
...
if (courseDetails) {
    ...
    console.log(`Instructor: ${((_a = courseDetails.instructor) === null || _a === void 0 ? void 0 : _a.name) || "Not assigned"}`);
